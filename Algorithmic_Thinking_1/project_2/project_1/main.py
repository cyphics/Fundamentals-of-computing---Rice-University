...
# print a_dpa._num_nodes, a_dpa._node_numbers
# Question 2
# part 1
# Yes, since every node is evaluated by every other node as a potential neighbors with the same probability.

# part 2
# it is a set of degree values all around the middle of the min/max values of degree

# part 3
# No they are not alike. Hard to describe it though. The random graph is like an inversed parabole
# in the middle.
